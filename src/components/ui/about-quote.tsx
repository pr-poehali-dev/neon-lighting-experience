        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              АкваСервис Крым — команда опытных сантехников с более чем 10-летним стажем. Мы работаем по всему полуострову: Симферополь, Севастополь, Ялта, Евпатория, Феодосия и другие города.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы не берём деньги за диагностику, называем точную цену до начала работ и даём гарантию на каждый выезд. Звоните в любое время — ночью, в выходные, в праздники. Прорыв воды не ждёт.
            </p>
          </div>
        </div>
      </div>
