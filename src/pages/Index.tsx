          ...
          <div className="mx-auto max-w-4xl">
            <div className="text-center px-0 leading-5">
              <h1 className="mb-8 text-balance text-5xl tracking-tight text-white [text-shadow:_0_4px_20px_rgb(0_0_0_/_60%)] md:text-6xl lg:text-8xl">
                <span className="font-open-sans-custom not-italic">Сантехник</span>{" "}
                <span className="font-serif italic">в Крыму.</span>{" "}
                <span className="font-open-sans-custom not-italic">24/7.</span>
              </h1>
              ...
              <p className="mb-8 mx-auto max-w-2xl text-pretty leading-relaxed text-gray-300 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-thin font-open-sans-custom tracking-wide leading-7 text-xl">
                Прорвало трубу, засор или сломался кран?{" "}
                <span className="font-serif italic">Приедем быстро</span> — работаем круглосуточно по всему полуострову
              </p>

              <div className="flex justify-center">
                <ShinyButton className="px-8 py-3 text-base">Вызвать мастера</ShinyButton>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="relative z-10 mx-auto w-full max-w-5xl">
            <div className="mx-auto mb-10 max-w-2xl text-center">
              ...
              <p className="text-gray-300 mt-4 text-sm md:text-base font-open-sans-custom [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)]">
                Прозрачные цены без скрытых доплат. Окончательная стоимость — после осмотра мастером.
              </p>
            </div>
            <BentoPricing />
          </div>
        ...
        >
          ...
          <div className="relative z-10 mx-auto w-full max-w-7xl">
            <div className="mx-auto mb-10 max-w-2xl text-center">
              ...
              <p className="text-gray-300 mt-4 text-sm md:text-base font-open-sans-custom [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)]">
                Более 10 лет опыта. Работаем по всему Крыму — честно, быстро, с гарантией.
              </p>
            </div>
            <AboutQuote />
          </div>
        ...
        >
          ...
          <div className="relative z-10 mx-auto w-full max-w-5xl mt-[5vh]">
            <ContactCard
              ...
              description="Оставьте заявку — перезвоним в течение 5 минут и согласуем удобное время. Работаем круглосуточно по всему Крыму."
              contactInfo={[
                {
                  icon: PhoneIcon,
                  label: "Телефон (24/7)",
                  value: "+7 (978) 000-00-00",
                },
                {
                  icon: MailIcon,
                  label: "Почта",
                  value: "info@akvakrym.ru",
                },
                {
                  icon: MapPinIcon,
                  label: "Работаем по всему Крыму",
                  value: "Симферополь, Севастополь, Ялта и др.",
            ...
            >
              <form action="" className="w-full space-y-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Textarea
                    placeholder="Прорвало трубу, засор, нужна установка..."
                    className="bg-white/10 border-white/20 text-white placeholder:text-gray-400 [text-shadow:_0_2px_6px_rgb(0_0_0_/_40%)]"
                  />
                </div>
                <Button
